...
очередь импорта партиями по 100 товаров — запускается одной командой:
...
Создайте одну ручную партию не более 100 товаров:
...
автоматически делит каталог на проверенные партии по 100.
